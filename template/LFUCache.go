...
// 		this.counter++
// 		this.pq.update(item, item.value, item.frequency+leetcode1, this.counter)
// 		return item.value
// 	}
// 	return -leetcode1
// }
...
// 	if item, ok := this.hash[key]; ok {
// 		this.pq.update(item, value, item.frequency+leetcode1, this.counter)
// 		return
// 	}
...
// 	old := *pq
// 	n := len(old)
// 	item := old[n-leetcode1]
// 	old[n-leetcode1] = nil  // avoid memory leak
// 	item.index = -leetcode1 // for safety
// 	*pq = old[0 : n-leetcode1]
// 	return item
// }
