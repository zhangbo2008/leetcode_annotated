...
// List2Ints convert List to []int 链表化为切片
...
// head's index is 0 //让链表的tail指向pos的索引.

// 不如之前链表是 0---->leetcode1----->2----...pos>------->tail
//变化之后是   0-------->pos-------tail->pos从pos位置开始成为一个圈.
// if pos = -leetcode1, no cycle
